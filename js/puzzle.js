function changeImage(idImage){
    ...
    console.log(idImageClick);
    if(nameImage==='funny') {
        document.getElementById(idImage).src = 'images/panda_swap_part'+idImageClick+'x1.jpg';
    }
    else if(nameImage==='monkey'){
        document.getElementById(idImage).src = 'images/funny-cat1_part3x1.jpg'+idImageClick+'x1.jpg';
    }
    else{
        document.getElementById(idImage).src = 'images/monkey_part1x1.jpg'+idImageClick+'x1.jpg';
    }
    checkWin();
}
...
function checkWin(){
    ...
    if(nameImage1==nameImage2 && nameImage2==nameImage3 && nameImage3==nameImage4 && nameImage4==nameImage5){
        //alert('win');
